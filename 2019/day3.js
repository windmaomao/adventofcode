...
const getPosArr = line => {
  ...
  return parts.reduce((acc, ins) => {
    ...
    // acc.h.push({ x: char, y: num })
    switch (char) {
      case 'R':
        acc.h.push({y: o.y, x: [o.x, o.x + num]})
        o.x = o.x + num
        break
      case 'U':
        acc.v.push({x: o.x, y: [o.y, o.y + num]})
        o.y = o.y + num
        break
      case 'L':
        acc.h.push({y: o.y, x: [o.x - num, o.x]})
        o.x = o.x - num
        break
      case 'D':
        acc.v.push({x: o.x, y: [o.y - num, o.y]})
        o.y = o.y - num
        break
    }
    return acc  
