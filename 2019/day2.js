...
const data = filereader.readFile('day2.data', ',', true)
const intcode = require('./day2_intcode')

const day21States = [...data]
day21States[1] = 12
day21States[2] = 2

console.log('Day 2/1 - Comp:', intcode([...day21States]))

const day22States = [...data]
day22States[1] = 62
day22States[2] = 55

console.log('Day 2/1 - Comp:', intcode([...day22States]))
