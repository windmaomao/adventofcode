...
const day12RepeatFind = () => {
  let repeat = { done: false, items: [0], current: 0, found: null }
  do {
    repeat = day12Find(repeat)
    console.log('middle', repeat.items.length)
  } while (!repeat.done)
  console.log('Found', repeat.found)
  return repeat
}
const day12Repeat = day12RepeatFind()

console.log('Day 1/2:', day12Repeat.found)
